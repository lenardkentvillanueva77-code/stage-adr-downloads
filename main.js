  ...
  const template = [
    ...
    }] : []),
    {
      ...
      submenu: [
        ...
        { label: 'Import Cue Map…', click: () => mainWindow?.webContents.send('menu:import-cue-map') },
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: 'Cue Map (All Cues)...', click: () => mainWindow?.webContents.send('menu:export-cue-map') },
        { label: 'Selected Cue Map...', click: () => mainWindow?.webContents.send('menu:export-selected-cue-map') },
        { label: 'Selected Cue Video...', click: () => mainWindow?.webContents.send('menu:export-cue-video') },
        { type: 'separator' },
